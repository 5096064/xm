...
Surge
[Script]
小米运动 = type=cron,cronexp="15 6 * * *",wake-system=1,timeout=3600,script-path=xmSports.js
...
[task_local]
# 小米运动
15 6 * * * xmSports.js, tag=小米运动, img-url=https://raw.githubusercontent.com/58xinian/icon/master/xmyd.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body xmSports.js
Loon
[Script]
cron "15 6 * * *" script-path=xmSports.js, tag=小米运动
