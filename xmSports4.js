...
Surge
[Script]
小米运动 = type=cron,cronexp="13 6 * * *",wake-system=1,timeout=3600,script-path=xmSports.js
...
[task_local]
# 小米运动
13 6 * * * xmSports.js, tag=小米运动, img-url=https://raw.githubusercontent.com/58xinian/icon/master/xmyd.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body xmSports.js
Loon
[Script]
cron "13 6 * * *" script-path=xmSports.js, tag=小米运动
...
let login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAKM-exEgt2VVM2dovo6w1MgkL9HzFKbAZ6ZS7uQPbK9v2vf9Q9m00xZd8MxTRlAj4MVMOkTekvvH__me4atFMV83pvDjSC9MjS1DG2P_d7E0NYiBY48nWnr6qzreAytw8WVuJzpQSetuaCe8vYLQ6BmtcWkIEzKGp--nBCi3U--nDd9DBMJ67VJGjpMQjZl4tEAGIHAB_nN4EmlMsnLrmbo';
