...
Surge
[Script]
小米运动 = type=cron,cronexp="12 6 * * *",wake-system=1,timeout=3600,script-path=xmSports.js
...
[task_local]
# 小米运动
12 6 * * * xmSports.js, tag=小米运动, img-url=https://raw.githubusercontent.com/58xinian/icon/master/xmyd.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body xmSports.js
Loon
[Script]
cron "12 6 * * *" script-path=xmSports.js, tag=小米运动
...
let login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAFE_tBWWWcVsl8PUw25PVgcBSeVrr8x6tHINqWsTOMoU4qpCTTIKyw0S5qvrtQ6HGjmohLf7-89m3DlJb97cVnUXdtGBClOWlSu1HnMhis947-g8V-vpi4YN4H7yM-NCTPQxQaD8iYNyfs_5w8FAqUAUkSkq2af1RALX_IHGG-A43E2MiE3M7_vqP9NPW-UcnIDCj5yhWU8-WLfUafWrusw';
