...
Surge
[Script]
小米运动 = type=cron,cronexp="10 6 * * *",wake-system=1,timeout=3600,script-path=xmSports.js
...
[task_local]
# 小米运动
10 6 * * * xmSports.js, tag=小米运动, img-url=https://raw.githubusercontent.com/58xinian/icon/master/xmyd.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body xmSports.js
Loon
[Script]
cron "10 6 * * *" script-path=xmSports.js, tag=小米运动
...
let login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAK-NyW5aBq-nMzW_2wKktPhvi28C3BVIqo440lvBAUZ3oBLc7MGxfKMtR6OTuJ1zHaboMEoZmXvIsQguQCYP3iOBbGkDd8DowYEGLG7f_Y3mJ3tZwatZo8DUh8eC5_3GU1wCArFH-KLWEfCRpHfozeBn9OCK4CyMPm6uYd7ijtAEi9iTlL8NkNfArCz1xrf-OT_IYkZWtIuJVCZZWuzk_DE';
