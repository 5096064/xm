...
Surge
[Script]
小米运动 = type=cron,cronexp="11 6 * * *",wake-system=1,timeout=3600,script-path=xmSports.js
...
[task_local]
# 小米运动
11 6 * * * xmSports.js, tag=小米运动, img-url=https://raw.githubusercontent.com/58xinian/icon/master/xmyd.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body xmSports.js
Loon
[Script]
cron "11 6 * * *" script-path=xmSports.js, tag=小米运动
...
let login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAElto8BfP2vFJq4bI5PL2oFQ-9iL1jI2SnyXlbSy3zAFjARQOaIpDvN5BWKKSIO_oHfeeXZfx9JX8NLSRd70ad080QXXjM_6oXyR2Jpo-diXAYjCROaCZvEH0acB94NVHyTgxZyBti3kwm65VyFQc3gLlFaYTvnb5ilP3nFiNQLNcjkN3xg0A5lCclZCASFUYL_av8J5eY-hy06ooPwjzR4';
