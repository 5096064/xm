...
Surge
[Script]
小米运动 = type=cron,cronexp="11 6 * * *",wake-system=1,timeout=3600,script-path=xmbs.js
...
[task_local]
# 小米运动
11 6 * * * xmbs.js, tag=小米运动, img-url=https://6678888.xyz/quantumultX/xmbs.png, enabled=true
[rewrite_local]
# 小米运动获取Token
^https:\/\/account\.huami\.com\/v2\/client\/login url script-response-body xmbs.js.js
Loon
[Script]
cron "11 6 * * *" script-path=xmbs.js, tag=小米运动
